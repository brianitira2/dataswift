      ...
      <main>
        <section className="featured-offer">
          ...
          <div className="offer-details">
            <img
              src="https://i.ibb.co/MnXXFbz/generate-a-cool-3d-rainbow-colours-splash-text-s-1.jpg"
              alt="generate-a-cool-3d-rainbow-colours-splash-text-s-1"
              border="0"
            />
            <div>
              <h3>Special Data Package</h3>
              <p>
                Get exclusive access to our limited-time data package. Stay
